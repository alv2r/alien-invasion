# Stores a number of functions that make Alien Invasion work. It will prevent
# alien_invasion.py from becoming too lengthy and will make the logic
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Check if any aliens have reached the bottom of th screen."""
    screen_rect = screen.get_rect()
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            # Treat this the same as if the ship gt hit.
