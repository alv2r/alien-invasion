...
# the code we have this class to store all the settings in one place. This
# approach allows us to pass around one settings object instead of many
# individual settings. In addition, it makes our function calls simpler and
# makes it easier to modify the game’s appearance as our project grows.
